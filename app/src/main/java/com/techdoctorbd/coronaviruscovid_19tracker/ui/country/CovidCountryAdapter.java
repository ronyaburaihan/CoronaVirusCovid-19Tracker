...
public class CovidCountryAdapter extends RecyclerView.Adapter<CovidCountryAdapter.CountryViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final CountryViewHolder holder, final int position) {
        ...
        holder.tvTotalCases.setText(String.valueOf(covidCountries.get(position).getmCases()));

        holder.countryItem.setOnClickListener(view -> {
            ...
            TextView totalTest = dialogView.findViewById(R.id.total_test_dialog);
            TextView testPerMillion = dialogView.findViewById(R.id.test_per_million_dialog);
            ...
            totalCases.setText(String.valueOf(covidCountries.get(position).getmCases()));
            ...
            totalTest.setText(covidCountries.get(position).getmTotalTests());
            testPerMillion.setText(covidCountries.get(position).getmTestsPerOneMillion());
